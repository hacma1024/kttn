...
<form action="Modules/CauHoi/xuli.php?quanli=cauhoi&ac=sua&trang=<?php echo $trang?>&id=<?php echo $dong["id"]?>" method="post" enctype="multipart/form-data">
<div id="left-cauhoi">
  <table class="table-them" width="682" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td><input type="text" name="txtdapan2" id="txtdapan2" size="72px" value="<?php echo $dong['dapan2']?>"/></td>
    </tr>
    <tr>
      <td height="32">Đáp án 3:</td>
      <td><input type="text" name="txtdapan3" id="txtdapan3" size="72px" value="<?php echo $dong['dapan3']?>"/></td>
    </tr>
    <tr>
      <td height="32">Đáp án 4:</td>
      <td><input type="text" name="txtdapan4" id="txtdapan4" size="72px" value="<?php echo $dong['dapan4']?>"/> 
      </td>
    </tr>
    <tr>
      <td height="45">Đáp án đúng:</td>
      <td>
      ...
      <label id="lbdadung" name="lbdadung" style="color: #A8000D; font-size:14px; font-style:italic; margin-left: 10px;"> =>
      <?php
      switch ($da)
      {
          case 1: 
    ...
    <tr>
      <td height="25"> Xáo:</td>
      <td><input type="checkbox" id="chkxao" name="chkxao" <?php if ($dong['xao']==1) echo "checked='checked'"?>/> </td>
    </tr>
    <tr>
      <td height="37"></td>
      <td>       
        <input class="button" type="button" name="btncapnhat2" id="btncapnhat2" value="   CẬP NHẬT   "> 
        <input class="button" type="submit" name="btncapnhat" id="btncapnhat" value="   CHUYỂN   " style="display:none;"> 
        &nbsp;&nbsp;&nbsp;
